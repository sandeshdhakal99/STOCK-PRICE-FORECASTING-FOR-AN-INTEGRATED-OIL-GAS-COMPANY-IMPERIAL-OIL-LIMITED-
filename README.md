...
This project builds a predictive analytics model to forecast the daily stock price of Imperial Oil Limited (IMO) by analyzing a combination of crude oil prices, macroeconomic indicators, and electric vehicle (EV) adoption trends in Canada.
Using advanced data preprocessing, statistical modeling, and machine learning, the project identifies the most influential factors affecting IMO’s valuation and delivers a robust forecasting solution for the Canadian energy sector.
